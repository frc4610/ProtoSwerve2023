...
public final class Constants {
  /**
     ...
     */
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = .572; 
    /**
     * The front-to-back distance between the drivetrain wheels.
     *
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = .66; 
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(1702); // FIXME Measure and set front left steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(70); // FIXME Measure and set back left steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(360*290 / 2048); 
